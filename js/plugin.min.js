...
!function(a, b, c) {
    ...
    a.fn.scrollUp.init = function(d) {
        ...
        scrollEvent = a(b).scroll(function() {
            switch (scrollDis = "top" === e.scrollFrom ? e.scrollDistance : a(c).height() - a(b).height() - e.scrollDistance,
            e.animation) {
            case "fade":
...
!function(e, t) {
    ...
    var ae = ne.document
      ...
      , i = function(e, t) {
        if (t = t || {},
        "string" == typeof e && (e = "#" === e.charAt(0) && -1 === e.indexOf(" ") ? ae.querySelector(e) : ae.querySelectorAll(e)),
        !e)
            return !1;
        var R = i.Helpers;
        void 0 !== t.maxWidth && (R.deprecated("maxWidth", "disableAt", "option"),
        ...
        var ee = []
          ...
          , n = function(e) {
            if (e.querySelector("ul") || "UL" === e.tagName) {
                ...
                c.addEventListener("click", R.stopPropagation),
                c.appendChild(v);
                var n, u, a, d = null, p = null, r = {}, f = !1, h = !1, m = null, y = 0, b = 0, g = 0, L = null, A = {}, x = [], C = !1, k = [], o = null, O = null, N = !1, T = !1;
                Z.customToggle ? (d = R.getElement(Z.customToggle)) && (d.classList.add("hc-nav-trigger", E),
                d.addEventListener("click", K)) : ((d = R.createElement("a", {
                    href: "#",
                    class: "hc-nav-trigger " + E,
                    "aria-label": (Z.ariaLabels || {}).open
                }, R.createElement("span"))).addEventListener("click", K),
                ...
                var w = function(e, t, n) {
                    if ("number" == typeof t && ("number" == typeof e || k.length)) {
                        ...
                        if (a = R.children(a, ".nav-content")[0],
                        a = R.children(a, "ul"),
                        a = R.children(a, "li"),
                        ...
                        a = Array.prototype.filter.call(a, function(e) {
                            ...
                            var r = a[0]
                              , i = a[a.length - 1];
                            "number" == typeof e ? a[e].focus() : (k[k.length - 1].focus(),
                            k.pop()),
                            ae.removeEventListener(s),
                            ae.addEventListener(s, function(e) {
                                "Tab" !== e.key && 9 !== e.keyCode || (e.shiftKey ? ae.activeElement === r && (e.preventDefault(),
                                i.focus()) : ae.activeElement === i && (e.preventDefault(),
                                r.focus()))
                            })
                        }
                    }
                  ...
                  , P = function() {
                    ...
                    r = function o(e, t) {
                        ...
                        Array.prototype.forEach.call(e, function(e) {
                            ...
                            null !== e.getAttribute("data-nav-active") && (m = t,
                            ...
                            Array.prototype.forEach.call(e.children, function(e) {
                                var t = null !== e.getAttribute("data-nav-custom-content")
                                  ...
                                  , i = null;
                                r.length && (R.data(e, "hc-uniqid") ? i = R.data(e, "hc-uniqid") : (i = Math.random().toString(36).substr(2),
                                R.data(e, "hc-uniqid", i))),
                                null !== e.getAttribute("data-nav-active") && (m = i,
                                e.removeAttribute("data-nav-active")),
                                s.items.push({
                                    id: i,
                    ...
                    [t[0]].concat(Array.prototype.filter.call(t[0].parentNode.children, function(e) {
                        return e !== t[0]
                    }))), null)
                }
                  , _ = function(e) {
                        ...
                        e.forEach(function(e, t) {
                            ...
                            e.items.forEach(function(e, t) {
                                ...
                                if (e.custom) {
                                    ...
                                    return Z.keepClasses && e.classes && a.classList.add.apply(a.classList, e.classes.split(" ")),
                                ...
                                Z.closeOnClick && (W() ? "A" !== r.tagName || "false" === r.dataset.navClose || null !== r.getAttribute("disabled") && "false" !== r.getAttribute("disabled") || e.subnav.length && (!r.getAttribute("href") || "#" === r.getAttribute("href").charAt(0)) || r.addEventListener("click", G) : "A" !== r.tagName || "false" === r.dataset.navClose || null !== r.getAttribute("disabled") && "false" !== r.getAttribute("disabled") || r.addEventListener("click", G));
                                var s = R.createElement("li");
                                if (s.appendChild(r),
                                h.appendChild(s),
                                Z.keepClasses && e.classes && (s.className = e.classes),
                                e.highlight && s.classList.add("nav-highlight"),
                                R.wrap(r, R.createElement("div", {
                                    ...
                                    W()) {
                                        ...
                                        var p = function(e) {
                                            e.addEventListener("click", function(e) {
                                                ...
                                                d.setAttribute("checked", "true" !== d.getAttribute("checked")),
                                                "createEvent"in ae) {
                                        ...
                                        if (-1 !== x.indexOf(c) && (g.classList.add("sub-level-open"),
                                        ...
                                        r.getAttribute("href") && "#" !== r.getAttribute("href")) {
                                            ...
                                            r.appendChild(R.createElement("span", {
                                                class: "nav-next"
                                            }, R.createElement("span"))),
                                            p(r)
                                    } else
                  ...
                  , t = function(t) {
                    return function(e) {
                        "left" !== Z.position && "right" !== Z.position || (o = e.touches[0].clientX,
                        O = e.touches[0].clientY,
                        "doc" === t ? T || (ae.addEventListener("touchmove", q, R.supportsPassive),
                        ae.addEventListener("touchend", D, R.supportsPassive)) : (T = !0,
                  ...
                  , j = function(e, t) {
                    ...
                    p && (p.style[R.browserPrefix("transition")] = "none",
                  ...
                  , B = function(e, t, n, a) {
                    ...
                    p && (p.style[R.browserPrefix("transition")] = "",
                  ...
                  , q = function(e) {
                    ...
                    ("left" === Z.position && o < 50 || "right" === Z.position && o > ae.clientWidth - 50) && (N = !0,
                    j(0 - (b - t), Math.abs(t)))
                }
                  , D = function e(t) {
                    if (ae.removeEventListener("touchmove", q),
                    ...
                    N) {
                        var n = t.changedTouches[t.changedTouches.length - 1]
                          ...
                          , i = b + r;
                        (a = "left" === Z.position ? Math.min(Math.max(a, 0), i) : Math.abs(Math.min(Math.max(a, -i), 0))) ? B(70 < a ? "open" : "close") : B("close", !1),
                        O = o = null,
                        N = !1
                    }
                }
                  , H = function(e) {
                    ...
                    if (!(Math.abs(t) < Math.abs(n))) {
                        ...
                        ("left" === Z.position && t < 0 || "right" === Z.position && 0 < t) && (N = !0,
                        j(-Math.abs(t) + a, r - Math.abs(t)))
                    }
                }
                  , I = function e(t) {
                    if (v.removeEventListener("touchmove", H),
                    ...
                    N) {
                        var n = t.changedTouches[t.changedTouches.length - 1]
                          ...
                          , r = "overlap" === Z.levelOpen ? F() * Z.levelSpacing : 0
                          , i = b + r;
                        (a = "left" === Z.position ? Math.abs(Math.min(Math.max(a, -i), 0)) : Math.abs(Math.min(Math.max(a, 0), i))) === i ? B("close", !1) : 50 < a ? B("close") : B("open", !0, r, i),
                        O = o = null,
                        N = !1
                    }
                };
                ...
                !0 === Z.expanded && (h = !0,
                Y()),
                Z.swipeGestures && (v.addEventListener("touchstart", t("nav"), R.supportsPassive),
                ...
                var U = function(e, t, n) {
                    ...
                    if (a) {
                        ...
                        n && "overlap" === Z.levelOpen && (s.removeEventListener("click"),
            ...
            function Y(e, t) {
                if ((!X() || void 0 !== t) && (function() {
                    ...
                    Z.disableBody && (y = ne.pageYOffset || re.scrollTop || ae.documentElement.scrollTop || ae.body.scrollTop,
                ...
                W())) {
                    ...
                    if ("number" != typeof e && !R.isNumeric(e) || "number" != typeof t && !R.isNumeric(t))
                        ...
                        !Z.closeActiveLevel && Z.closeOpenLevels || (m = null)) : !1 === Z.closeOpenLevels && (n = (n = Array.prototype.filter.call(v.querySelectorAll(".hc-chk"), function(e) {
            ...
            function G() {
                if (X()) {
                    ...
                    "expand" === Z.levelOpen && -1 !== ["top", "bottom"].indexOf(Z.position) ? J(0) : W() && (L = setTimeout(function() {
                        J(0)
                    }, "expand" === Z.levelOpen ? u : 0)),
                    Z.disableBody && (ae.body.classList.remove("hc-nav-open"),
                    re.classList.remove("hc-nav-yscroll"),
                    y)) {
                        if (ae.body.style.top = "",
                        ae.body.scrollTop = y,
                        re.scrollTop = y,
                        "bottom" === Z.position) {
                            var e = y;
                    ...
                    setTimeout(function() {
                        c.style.visibility = "",
                        c._eventListeners.close && c._eventListeners.close.forEach(function(e) {
            ...
            function $(t, n, e) {
                ...
                "overlap" === Z.levelOpen && (s.addEventListener("click", function() {
                    return J(t, n)
                }),
    ...
    return ne.hcOffcanvasNav = ne.hcOffcanvasNav || i,
    i
}),
function(n) {
    ...
    e.Helpers = {
        ...
        getElement: function(e) {
            var t = null;
            return "string" == typeof e ? t = o.querySelector(e) : n.jQuery && e instanceof n.jQuery && e.length ? t = e[0] : e instanceof Element && (t = e),
            t
        },
